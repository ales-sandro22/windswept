...
public class WindsweptRecipeProvider extends BlueprintRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output, HolderLookup.Provider holderLookup) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, MUTTON_PIE.get()).requires(TagUtil.itemTag("c", "foods/cooked_mutton")).requires(Items.WHEAT).requires(Items.SUGAR).requires(Tags.Items.EGGS).unlockedBy(getHasName(Items.COOKED_MUTTON), has(Items.COOKED_MUTTON)).save(output, getSaveLocation(MUTTON_PIE.get()));
